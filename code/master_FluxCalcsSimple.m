...
switch Glacier
    case 'Rongbuk'
        ...
        segdist = 200; %effective linear distance between flowbands
...
%         THX.path = fullfile(homedir,'data',Glacier,'RGI60-01.10557_thickness_composite.tif');
    ...
    case 'Aletsch'
        ...
        segdist=250; %effective linear distance between flowbands
...
%     N.THX = griddata(THX.xN(:),THX.yN(:),double(THX.data(:)),N.x3g(:),N.y3g(:),'cubic');
    ...
    N.FDIV0=N.FDIV;
    N.FDIV = flowfilter_varsig(N,N.FDIV);
...
if plotouts==1
    ...
    cmap2 = [flipud(cbrewer('seq','Reds',101));cbrewer('seq','Blues',50)];
