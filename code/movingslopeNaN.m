function Dvec = movingslopeNaN(vec,supportlength,modelorder,dt)
...
%   Dvec(i) = coef*vec(1:supportlength); %original
  
  V=vec(1:supportlength);
  nans=isnan(V);
  V(nans)=0;
  W=1-nans;
