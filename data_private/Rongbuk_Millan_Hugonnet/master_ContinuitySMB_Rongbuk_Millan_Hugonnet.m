...
%glacier ID
P.Glacier = 'Rongbuk_Millan_Hugonnet'

%title of output directory
datatitle = ['test_' P.Glacier];

%inputs        
V.pathx = fullfile(homedir,'data_private',P.Glacier,'15.09991_U.tif');
V.pathy = fullfile(homedir,'data_private',P.Glacier,'15.09991_V.tif');
...
DH.path = fullfile(homedir,'data_private',P.Glacier,'15.09991_dH_Hugonnet.tif');
DH.mult=1; %scale to convert input units to m/a
THX.path = fullfile(homedir,'data_private',P.Glacier,'RGI60-15.09991_thickness_composite.tif');
DEM.path = fullfile(homedir,'data_private',P.Glacier,'15.09991_AW3D.tif');
